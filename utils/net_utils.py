...
def init_prune_rate(module, prune_rate):
    if hasattr(module, "init_prune_rate"):
        module.init_prune_rate(prune_rate)


def init_prune_criterion(module, prune_criterion):
    if hasattr(module, "init_prune_criterion"):
        module.init_prune_criterion(prune_criterion)


def do_grad_decay(module, decay):
    if hasattr(module, "do_grad_decay"):
        module.do_grad_decay(decay)


def show_zero_num(module):
    if hasattr(module, "show_zero_num"):
        module.show_zero_num()


def update_mask(module):
    if hasattr(module, "update_mask"):
        module.update_mask()
