...
from utils.net_utils import accuracy, AverageMeter, do_grad_decay, forward_func

scaler = GradScaler()


def train(train_loader, model, criterion, optimizer, epoch, log, print_log, args):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        if args.decay_type == 'v1':
            model.apply(partial(do_grad_decay, decay=args.decay))
        else:
