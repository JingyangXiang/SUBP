...
def parse_arguments():
    ...
    parser.add_argument('--lr', '--learning-rate', default=0.512, type=float, metavar='LR',
                        help='initial learning rate')
    parser.add_argument('--momentum', default=0.875, type=float, metavar='M', help='momentum')
    ...
    parser.add_argument('--conv-type', type=str, default='DenseConv2d',
                        choices=models.conv_type.__all__, help='decay type for conv type')
    ...
    parser.add_argument('--prune-schedule', default='linear', choices=['linear', 'exp', 'cos', 'cubic'],
    ...
    parser.add_argument('--engine', default='step', choices=utils.engine.__all__,
