...
class SoftRegrowUniformBlockConv2d(RegrowUniformBlockConv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, **kwargs):
        super(SoftRegrowUniformBlockConv2d, self).__init__(SoftParameterMasker, in_channels, out_channels, kernel_size,
                                                           stride=stride, **kwargs)


class HardRegrowUniformBlockConv2d(RegrowUniformBlockConv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, **kwargs):
        super(HardRegrowUniformBlockConv2d, self).__init__(HardParameterMasker, in_channels, out_channels, kernel_size,
                                                           stride=stride, **kwargs)
