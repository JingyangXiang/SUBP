...
def resnet18_cifar(pretrained=False, builder=None, num_classes=10):
    if pretrained:
        raise NotImplementedError
    return ResNet(builder, BasicBlock, [2, 2, 2, 2], num_classes)


def resnet34_cifar(pretrained=False, builder=None, num_classes=10):
    if pretrained:
        raise NotImplementedError
    return ResNet(builder, BasicBlock, [3, 4, 6, 3], num_classes)


def resnet50_cifar(pretrained=False, builder=None, num_classes=10):
    if pretrained:
        raise NotImplementedError
    return ResNet(builder, Bottleneck, [3, 4, 6, 3], num_classes)


def resnet101_cifar(pretrained=False, builder=None, num_classes=10):
    if pretrained:
        raise NotImplementedError
    return ResNet(builder, Bottleneck, [3, 4, 23, 3], num_classes)


def resnet152_cifar(pretrained=False, builder=None, num_classes=10):
    if pretrained:
        raise NotImplementedError
